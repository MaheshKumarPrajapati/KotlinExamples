package com.mahesh_prajapati.kotlin_examples.coroutine

import kotlinx.coroutines.*

fun main(array: Array<String>)= runBlocking {    // Creates a blocking coroutine that executes in current thread (main)
    ...
    job.join()      // main thread: wait for coroutine to finish
       // main thread: wait for coroutine to finish
